...
void set_servo(uint32_t servo,float value)
{
	...
	{
		case 1:
			TIM3->CCR2 = value*1615.5f+3231;
			break;
		case 2:
			TIM3->CCR3 = value*1615.5f+3231;
			break;
		case 3:
			TIM3->CCR4 = value*1615.5f+3231;
			break;
		case 4:
			TIM3->CCR1 = value*1615.5f+3231;
			break;
		case 5:
			TIM4->CCR3 = value*1615.5f+3231;
			break;
		case 6:
			TIM4->CCR4 = value*1615.5f+3231;
			break;
		case 7:
