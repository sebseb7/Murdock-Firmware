...
void MPU6050_Initialize() 
{
	...
	MPU6050_I2C_ByteWrite2(MPU6050_ADDRESS, 0x1A,4);//filter with 94hz (0..6)
	MPU6050_WriteBit(MPU6050_ADDRESS, MPU6050_RA_INT_ENABLE, MPU6050_INTERRUPT_DATA_RDY_BIT,TRUE);
	
	MPU6050_WriteBit(MPU6050_ADDRESS, MPU6050_RA_USER_CTRL, MPU6050_USERCTRL_I2C_MST_EN_BIT,FALSE);
	delay(3);
	MPU6050_WriteBit(MPU6050_ADDRESS, MPU6050_RA_INT_PIN_CFG, MPU6050_INTCFG_I2C_BYPASS_EN_BIT,TRUE);
}
