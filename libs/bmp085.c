...
void BMP085_getCalData(void) {
	ac1 = i2c2_reads16(BMP_I2C_ADDR,CAL_AC1);
	ac2 = i2c2_reads16(BMP_I2C_ADDR,CAL_AC2);
	ac3 = i2c2_reads16(BMP_I2C_ADDR,CAL_AC3);
	ac4 = i2c2_readu16(BMP_I2C_ADDR,CAL_AC4);
	ac5 = i2c2_readu16(BMP_I2C_ADDR,CAL_AC5);
	ac6 = i2c2_readu16(BMP_I2C_ADDR,CAL_AC6);
	b1 = i2c2_reads16(BMP_I2C_ADDR,CAL_B1);
	b2 = i2c2_reads16(BMP_I2C_ADDR,CAL_B2);
	mb = i2c2_reads16(BMP_I2C_ADDR,CAL_MB);
	mc = i2c2_reads16(BMP_I2C_ADDR,CAL_MC);
	md = i2c2_reads16(BMP_I2C_ADDR,CAL_MD);
...
void BMP085_readTemperature(void){
	...
	i2c2_write(BMP_I2C_ADDR,CONTROL, READ_TEMPERATURE);
	delay(7);                          // min. 4.5ms read Temp delay
	ut = i2c2_readu16(BMP_I2C_ADDR,0xF6);
...
void BMP085_readPressure(void)
{
	...
	//read Raw Pressure
	i2c2_write(BMP_I2C_ADDR,CONTROL, READ_PRESSURE+(MODE_ULTRA_HIGHRES << 6));
	delay(26);
	up += i2c2_reads24(BMP_I2C_ADDR,0xF6) >> (8-MODE_ULTRA_HIGHRES);
